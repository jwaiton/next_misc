...
INFILE="/gluster/data/next/files/TOPOLOGY_John/HYPPOS_DATA_QTHR/BEERSHEBA_STUDY/satkill/PORT_${PORT}/beersheba/beersheba_${NUMBER}_208Tl.h5"
...
ISAUFILE="/gluster/data/next/files/TOPOLOGY_John/HYPPOS_DATA_QTHR/BEERSHEBA_STUDY/satkill/PORT_${PORT}/isaura/isaura_${NUMBER}_208Tl.h5"
...
## Generate IC config
CFG_MACRO_ISAURA="/gluster/data/next/files/TOPOLOGY_John/Configs/isaura.SATKILL.NEXT100_${NUMBER}.config"
