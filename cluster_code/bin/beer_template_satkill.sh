...
SOPHFILE="/gluster/data/next/files/TOPOLOGY_John/HYPPOS_DATA_QTHR/Q_THR4/PORT_${PORT}/sophronia/sophronia_${NUMBER}_208Tl.h5"

INFILE="/gluster/data/next/files/TOPOLOGY_John/HPR_PARAMETER_CHECK/hypathia_data/PORT_${PORT}/hypathia_${NUMBER}_208Tl.h5"
BEERFILE="/gluster/data/next/files/TOPOLOGY_John/HYPPOS_DATA_QTHR/BEERSHEBA_STUDY/satkill/PORT_${PORT}/beersheba/beersheba_${NUMBER}_208Tl.h5"
...
# for running the FOM
DIRECTORY="/gluster/data/next/files/TOPOLOGY_John/HYPPOS_DATA_QTHR/BEERSHEBA_STUDY/satkill/PORT_${PORT}/"
#############################
# BEERSHEBA MACRO AND RUNTIME
############################

## Generate IC config
CFG_MACRO="/gluster/data/next/files/TOPOLOGY_John/Configs/sophronia.SATKILL.NEXT100.${E_CUT}_${N_ITER}_${NUMBER}.config"
...
CORRECTION_MAP="/gluster/data/next/files/TOPOLOGY_John/LPR/LightTables/map_NEXT100_MC_5bar.h5"
...
echo "corrections_file = '${CORRECTION_MAP}'"                   >> ${CFG_MACRO}
echo "apply_temp       = False"				        >> ${CFG_MACRO}
