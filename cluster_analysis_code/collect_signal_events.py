...
def main():
    ...
    np.save(dir_name_rel + 'signal_plots/time_spent_satkill' + str(file_no) + '.npy', np.array(time_spent))
    np.save(dir_name_rel + 'signal_plots/track_num_satkill' + str(file_no) + '.npy', np.array(track_number))
    np.save(dir_name_rel + 'signal_plots/true_trk_num' + str(file_no) + '.npy', np.array(true_trk_number))
    np.save(dir_name_rel + 'signal_plots/eventids_satkill' + str(file_no) + '.npy', np.array(event_ids))
