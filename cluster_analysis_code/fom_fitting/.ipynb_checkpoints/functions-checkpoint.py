...
def energy_track_plots(tracks, title = "Low pressure track energies", limit = [0], ybins = 11):
    '''
    ...
    plt.hist2d(track_energy, track_no, weights = weights, bins=(100, ybins), cmin=0.0005)
    if limit == [0]:
