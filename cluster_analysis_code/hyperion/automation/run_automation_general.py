...
for file in "$INPUT_DIR"/*; do
    ...
    echo "deconv_params = dict(
        ...
        drop_dist = [16., 16., 4.],
        cluster_size = 5,
        psf_fname = '/scratch/halmazan/NEXT/N100_LPR/lighttables/040925_full_25us.psf',
        e_cut = 0.2,
        n_iterations = 20,
        iteration_tol = 1e-09,
...
def run_city_beersheba(TIMESTAMP, RUNS, CITY, JOB_TYPE, CORR_TS, MC, blobR, scanR, voxelS):
...
def run_city_isaura(TIMESTAMP, RUNS, CITY, JOB_TYPE, CORR_TS, MC, blobR, scanR, voxelS):
    JOB_TYPE        = 'isaura'
    CITY            = 'isaura'
...
def run_city_topology(TIMESTAMP, RUNS, CITY, JOB_TYPE, CORR_TS, MC, blobR, scanR, voxelS):
...
def run_full_param_scan(TIMESTAMP, RUNS, CITY, JOB_TYPE, CORR_TS, MC, blobR, scanR, voxelS):
...
def main():
    ...
    for TS in TSs:
        ...
        run_full_param_scan(TS, RUNS, CITY, JOB_TYPE, CORR_TS, MC, blobR, scanR, voxS)
