...
OUTPUT_DIR="/scratch/halmazan/NEXT/N100_LPR/{RUN}/beersheba/{TIMESTAMP}/ldc{LDC}"
...
INPUT_DIR="/scratch/halmazan/NEXT/N100_LPR/{RUN}/beersheba/{INPT_TIMESTAMP}/ldc{LDC}"
...
def run_full_param_scan(TIMESTAMP, blobR, scanR, voxelS):
    ...
    BEER_TS         = 354015 # timestamp of the beersheba work you care about,
                             # need to take it from run_automation_beersheba
