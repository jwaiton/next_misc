...
def plotter(df, evt, cut_n_drop = True, show = True, deconv = False, cut_sensors = None, drop_sensors = None):
...
def plot_hist(df, column = 'energy', binning = 20, title = "Energy plot", output = False, fill = True, label = 'default', x_label = 'energy (MeV)', range = 0, outliers = None, log = True, data = False, save = False, save_dir = '', alpha = 1):
    '''
