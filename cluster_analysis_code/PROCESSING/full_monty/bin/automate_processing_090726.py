...
def run_thekla( LDC   : int
    ...
    thekla_script = f"{scratch_dir}PROCESSING/full_monty/bin/run_thekla_090626.sh"
...
if __name__ == '__main__':
    ...
    SECONDARY_MAP = 0
    print('topology cuts')
    print(repr(sys.argv[6]))
    topo_cuts     = json.loads(sys.argv[6])
    LDC           = sys.argv[7]
    TIMESTAMP     = str(sys.argv[8])
