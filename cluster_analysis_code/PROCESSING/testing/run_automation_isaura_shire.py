...
INPUT_DIR="/data/halmazan/NEXT/{s_path}/{RUN}/beershebashire/{INPT_TIMESTAMP}/ldc{LDC}"
...
def main():
    ...
    #RUNS            = [15589, 15590, 15591]#, 15590]#[15589, 15590]#, 15591, 15592]
    RUNS = [15590]

    # MC STANDERD 11/07/25
    #CORR_TS         = 202510 # The corrected sophronia data timestamp

    CORR_TS          = '041225' # the beershebashire timestamp
    #CORR_TS          = 230725
